...
(function() {
	...
	tinymce.PluginManager.requireLangPack('mimage');
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceImages', function() {
				ed.windowManager.open({
					file : url + '/images.htm',
					width : 700 + parseInt(ed.getLang('mimage.delta_width', 0)),
					height : 550 + parseInt(ed.getLang('mimage.delta_height', 0)),
					inline: true,
					popup_css : false
				}, {
					plugin_url : url
	...
	// Register plugin
	tinymce.PluginManager.add('mimage', tinymce.plugins.ImagesPlugin);
})();