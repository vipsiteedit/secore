<?php
function module_mbbs($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mbbs';
 else $__MDL_URL = 'modules/mbbs';
 $__MDL_ROOT = dirname(__FILE__).'/mbbs';
 ...
 // START PHP
 //2
 $req = getRequestList($req, '', VAR_STRING);
 ...
 $edkey=$section->language->lang012;
 $edtitle=$section->language->lang012;
 $townselected = utf8_substr(getRequest('townselected', VAR_STRING), 0, 60);
