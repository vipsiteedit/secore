<?php
function module_mshop_cart_big51($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mshop_cart_big51';
 else $__MDL_URL = 'modules/mshop_cart_big51';
 $__MDL_ROOT = dirname(__FILE__).'/mshop_cart_big51';
 ...
 if(isset($_POST['confirm_order'])) {
     ...
     $order_delivery = array(
         ...
         'address' => /*getRegionName(1) . '. ' . */$_SESSION['cartcontact']['address'],
     ...
     if ($section->parametrs->param17 == 'Y') {
 ...
 $total_weight_goods = $total['weight'] . '&nbsp<span class="measure">' . $section->language->lang081 . '</span>';
 $total_volume_goods = $total['volume'] . '&nbsp<span class="measure">' . $section->language->lang082 . '</span>';
