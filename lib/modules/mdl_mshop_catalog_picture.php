<?php
function module_mshop_catalog_picture($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mshop_catalog_picture';
 else $__MDL_URL = 'modules/mshop_catalog_picture';
 $__MDL_ROOT = dirname(__FILE__).'/mshop_catalog_picture';
