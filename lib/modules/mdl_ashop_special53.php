<?php
function module_ashop_special53($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/ashop_special53';
 else $__MDL_URL = 'modules/ashop_special53';
 $__MDL_ROOT = dirname(__FILE__).'/ashop_special53';
 ...
 list($width, $height) = explode('x', $section->parametrs->param48);
 $img_style = 'max-width:'.$width.'px;';
