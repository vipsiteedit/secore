    ...
    <div class="productItem">
        ...
        <div class="blockInfo">
            ...
            <?php if(strval($section->parametrs->param275)=='Y'): ?>
               <div class="objectTitle"><a class="textTitle" href="<?php echo $record->linkshow ?><?php echo $section->parametrs->param330 ?>"><?php echo $record->name ?></a></div>
            ...
            <?php else: ?>
                <div class="objectTitle"><span class="textTitle"><?php echo $record->name ?></span></div>
            <?php endif; ?>
