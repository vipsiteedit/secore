...
<section class="content ashopvit_compl <?php if(strval($section->parametrs->param337)=='n'): ?>container<?php else: ?>container-fluid<?php endif; ?>" data-type="<?php echo $section->type ?>" data-id="<?php echo $section->id ?>" >
