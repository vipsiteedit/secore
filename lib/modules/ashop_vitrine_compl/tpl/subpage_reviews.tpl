        ...
        <div class="addReview" style="display:none;">
            <form method="post" action="">
                ...
                <div class="addMerits form-group">
                    ...
                    <textarea id="merits" class="form-control" name="review[merits]" placeholder="<?php echo $section->language->lang071 ?>"></textarea>
                </div>
                <div class="addDemerits form-group">
                    <label for="demerits"><?php echo $section->language->lang068 ?></label>
                    <textarea id="demerits" class="form-control" name="review[demerits]" placeholder="<?php echo $section->language->lang072 ?>"></textarea>
                </div>
                <div class="addComment form-group">
                    <label for="comment"><span class="star">*</span><?php echo $section->language->lang069 ?></label>
                    <textarea id="comment" class="form-control" name="review[comment]" placeholder="<?php echo $section->language->lang073 ?>" required></textarea>
                </div>
                ...
                <div class="blockButton form-group">
                    <button class="buttonSend btnAdd btn btn-default"><span><?php echo $section->language->lang078 ?></span></button>
                    <a class="linkCancel btn btn-link" href="javascript:void(0)"><?php echo $section->language->lang079 ?></a>
                </div>
            </form>
        </div>
        <?php endif; ?>
...
<?php endforeach; ?>
    ...
    <?php endif; ?>
    <?php if($user_group==0): ?>
        <a href="#" class="msgAuth se-login-modal" data-target="#reviews"><?php echo $section->language->lang080 ?></a>
    <?php endif; ?>    
