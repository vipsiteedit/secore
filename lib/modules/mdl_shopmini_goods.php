<?php
function module_shopmini_goods($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/shopmini_goods';
 else $__MDL_URL = 'modules/shopmini_goods';
 $__MDL_ROOT = dirname(__FILE__).'/shopmini_goods';
