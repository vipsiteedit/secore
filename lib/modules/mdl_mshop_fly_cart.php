<?php
function module_mshop_fly_cart($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mshop_fly_cart';
 else $__MDL_URL = 'modules/mshop_fly_cart';
 $__MDL_ROOT = dirname(__FILE__).'/mshop_fly_cart';
