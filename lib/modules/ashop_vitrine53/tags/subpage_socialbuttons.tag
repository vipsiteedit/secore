...
<div class="socialButtons">
    <div class="social-likes social-likes_vertical_ social-likes_single_" data-single-title="Поделиться" <noempty:{$product_name}>data-title="{$product_name}"</noempty> <noempty:{$product_link}>data-url="{$product_link}"</noempty>>
