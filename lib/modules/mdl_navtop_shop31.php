<?php
function module_navtop_shop31($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/navtop_shop31';
 else $__MDL_URL = 'modules/navtop_shop31';
 $__MDL_ROOT = dirname(__FILE__).'/navtop_shop31';
