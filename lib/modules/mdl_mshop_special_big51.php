<?php
function module_mshop_special_big51($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mshop_special_big51';
 else $__MDL_URL = 'modules/mshop_special_big51';
 $__MDL_ROOT = dirname(__FILE__).'/mshop_special_big51';
