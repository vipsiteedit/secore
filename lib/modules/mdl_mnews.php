<?php
function module_mnews($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mnews';
 else $__MDL_URL = 'modules/mnews';
 $__MDL_ROOT = dirname(__FILE__).'/mnews';
 ...
 include $__data->include_tpl($section, "arhiv");
