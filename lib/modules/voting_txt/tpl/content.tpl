...
<?php endforeach; ?>
                ...
                <tr>
                    <td colspan=2 style="padding-left:10px;">
                        <font color="<?php echo $section->parametrs->param4 ?>">
                            <b id="restitle"><?php echo $section->parametrs->param3 ?>: <?php echo $summ ?></b>
                        </font>
                    </td>
                </tr>
                <?php foreach($__data->limitObjects($section, $section->objectcount) as $record): ?>
                ...
                <tr> 
                    <td colspan="2" vAlign="middle" align="center">
                        <table border="0" cellpadding="0" cellspacing="0" id="areaButton">
                            <tr> 
                                <td>
                                    <input name="GoTo_VOTING" id="buttonVoting" class="buttonSend" <?php echo $voting_text->buttonstyle ?> type='submit' value="<?php echo $section->parametrs->param5 ?>">
                                </td> 
                                <td>&nbsp;</td> 
                                <td>
                                    <input name="GoTo_SHOW" class="buttonSend" id="buttonResult" <?php echo $voting_text->buttonstyle ?> type='submit' value="<?php echo $section->parametrs->param6 ?>">
