var anavmenu_catalog_execute = function(params){ 
...
$('.headerCatalog .headerCatalogItem.horiz.catalog').hover(function(){
    ...
    if ($.inArray(id,prsSub) == -1) {
        ...
        $('.headerCatalogSub').append("<div class='loadering' style='width:100%; margin-top:-20px; text-align:center; padding:20px;'></div>");
    }
    else {
        $('.loadering').remove();
    }
