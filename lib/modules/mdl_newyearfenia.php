<?php
function module_newyearfenia($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/newyearfenia';
 else $__MDL_URL = 'modules/newyearfenia';
 $__MDL_ROOT = dirname(__FILE__).'/newyearfenia';
