<?php
function module_mshop_region($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mshop_region';
 else $__MDL_URL = 'modules/mshop_region';
 $__MDL_ROOT = dirname(__FILE__).'/mshop_region';
