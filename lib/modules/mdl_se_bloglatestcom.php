<?php
function module_se_bloglatestcom($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/se_bloglatestcom';
 else $__MDL_URL = 'modules/se_bloglatestcom';
 $__MDL_ROOT = dirname(__FILE__).'/se_bloglatestcom';
