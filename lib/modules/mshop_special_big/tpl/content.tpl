...
<script type="text/javascript" src="[module_url]mshop_special_big.js"></script>
<script type="text/javascript"> mshop_special_big_execute({'id':<?php echo $section->id ?>,p32:'<?php echo $section->parametrs->param32 ?>'});</script>
<?php endif; ?>
<?php if(strval($section->parametrs->param33)=='rotate'): ?>
