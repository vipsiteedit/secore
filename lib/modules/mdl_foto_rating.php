<?php
function module_foto_rating($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/foto_rating';
 else $__MDL_URL = 'modules/foto_rating';
 $__MDL_ROOT = dirname(__FILE__).'/foto_rating';
 ...
 // START PHP
 $GR_AUTHOR = seUserGroup();
 se_rating_list($section, $section->parametrs->param1, $section->parametrs->param2); 
 //print_r($section->objects[0]);

   $section->objectcount = intval($section->parametrs->param6);
 // include content.tpl
