...
<?php if($section->parametrs->param46=='Y' || $section->parametrs->param33=='rotate'): ?>
...
draggableSpecial(<?php echo $section->id ?>, '<?php echo $section->parametrs->param32 ?>');
});
</script>
<?php endif; ?>
...
<div class="content contSpecialGoods" <?php echo $section->style ?>>
...
<?php endforeach; ?> 
    ...
    <?php endif; ?>
    <?php if($section->parametrs->param33=='block'): ?>
