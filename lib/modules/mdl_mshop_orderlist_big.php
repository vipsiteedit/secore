<?php
function module_mshop_orderlist_big($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mshop_orderlist_big';
 else $__MDL_URL = 'modules/mshop_orderlist_big';
 $__MDL_ROOT = dirname(__FILE__).'/mshop_orderlist_big';
