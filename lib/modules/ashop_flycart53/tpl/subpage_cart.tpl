    ...
    <div id="bodyCart">
        <div class="shortInfoCart" <?php if(strval($section->parametrs->param19)=='ext'): ?>style="display:none;"<?php endif; ?>>
        ...
        <div class="extendInfoCart" style="height:100%;<?php if(strval($section->parametrs->param19)=='short'): ?>display:none;<?php endif; ?>">
