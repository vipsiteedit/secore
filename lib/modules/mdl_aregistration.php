<?php
function module_aregistration($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/aregistration';
 else $__MDL_URL = 'modules/aregistration';
 $__MDL_ROOT = dirname(__FILE__).'/aregistration';
 ...
 // START PHP
 $frommail = $section->parametrs->param4;
 
 if (seUserId() && $__data->req->sub!='1') {
     return;
 }
