...
<header:js>
  ...
  <div id="tabs">
    <ul>
      <li><a href="#tabs-1"><?php echo $section->parametrs->param7 ?></a></li>
      <li><a href="#tabs-2"><?php echo $section->parametrs->param8 ?></a></li>
         ...
         <?php foreach($section->blogsposlcomm as $record): ?>
                <div  class="kazdcomm">   
                    ...
                    <div class="razdelitel2">
                     <?php echo $section->parametrs->param10 ?>
                    </div>
                    <div class="data">
         ...
         <?php foreach($section->blogspopularposts as $poslcom): ?>
                <div  class="kazdcomm">   
                   ...
                   <div class="razdelitel3">
                     <?php echo $section->parametrs->param9 ?>
                    </div>
                    <div class="prosm">
