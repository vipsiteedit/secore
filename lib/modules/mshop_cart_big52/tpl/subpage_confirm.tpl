...
<?php endforeach; ?>                                                                                                                   
    ...
    <div class="buttonBlock">       
        <form style="margin:0px;" action="?<?php echo $time ?>" method="post" enctype="multipart/form-data">
            <input class="btnReturnInCart buttonSend" type="submit" value="<?php echo $section->language->lang051 ?>">
            
            <input class="btnConfirmOrder buttonSend" type="submit" name="confirm_order" value="<?php echo $section->language->lang020 ?>">
        </form>
    </div>
