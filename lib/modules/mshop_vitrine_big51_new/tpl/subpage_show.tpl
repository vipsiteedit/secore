        ...
        <div class="goodsDetail" itemscope itemtype="http://schema.org/Product">
            ...
            <div class="goodsLinkPhoto">
                <a href="<?php echo $img_full ?>" title="<?php echo $price_img_alt ?>"  target="_blank">
                    <img class="goodsPhoto  img-responsive center-block" style="max-width:100%;" src="<?php echo $img_mid ?>" alt="<?php echo $price_img_alt ?>" data-large="<?php echo $img_full ?>" itemprop="image">
                </a>
            </div>           
            ...
            <?php if(!empty($brand_image)): ?>
                <a class="brandImage" href="<?php echo $brand_link ?>" title="<?php echo $product_brand ?>">
            ...
            <div class="goodsDetPriceBox" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                ...
                <form class="form_addCart" name="formtop" style="margin:0px;" method="post" action="">
                    <?php if(strval($section->parametrs->param138)=='Y'): ?>
                        <div class="addCount">
                            <label for="add_count"><?php echo $section->language->lang099 ?></label>
                    ...
                    <div class="goodsButton">
                        ...
                        <button class="buttonSend addcart" title="<?php echo $section->language->lang022 ?>" <?php if(empty($maxcnts)): ?><?php if(strval($section->parametrs->param233)=='Y'): ?>disabled<?php else: ?>style="display:none;"<?php endif; ?><?php endif; ?>><?php echo $section->language->lang033 ?></button>
                        <?php if($quickview==''): ?>
                            <button class="buttonSend back" onclick="history.back();return false;"><?php echo $section->language->lang031 ?></button>
                        <?php else: ?>
                            <a class="lnkDetail" href="<?php echo $product_link ?><?php echo $section->parametrs->param330 ?>"><?php echo $section->language->lang032 ?></a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
