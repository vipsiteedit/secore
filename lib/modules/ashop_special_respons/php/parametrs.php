<?php
 if (!isset($section->parametrs->param1) || $section->parametrs->param1=='') $section->parametrs->param1 = "n";
 if (!isset($section->parametrs->param5) || $section->parametrs->param5=='') $section->parametrs->param5 = "8";
 if (!isset($section->parametrs->param48) || $section->parametrs->param48=='') $section->parametrs->param48 = "400x400";
 ...
 if (!isset($section->parametrs->param29) || $section->parametrs->param29=='') $section->parametrs->param29 = "Y";
 if (!isset($section->parametrs->param51) || $section->parametrs->param51=='') $section->parametrs->param51 = "c";
 ...
 if (!isset($section->parametrs->param50) || $section->parametrs->param50=='') $section->parametrs->param50 = "50";
 ...
 if (!isset($section->parametrs->param27) || $section->parametrs->param27=='') $section->parametrs->param27 = "Y";
