<?php
function module_mremember_new($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mremember_new';
 else $__MDL_URL = 'modules/mremember_new';
 $__MDL_ROOT = dirname(__FILE__).'/mremember_new';
