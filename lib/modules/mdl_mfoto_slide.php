<?php
function module_mfoto_slide($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mfoto_slide';
 else $__MDL_URL = 'modules/mfoto_slide';
 $__MDL_ROOT = dirname(__FILE__).'/mfoto_slide';
