var mshop_special_big51_execute = function(params){ 
...
if (params.p46=='Y') {
draggableSpecial(params.id, params.p32);
specialModifications(params.id);
}

if(params.p33=='rotate'){
$('#partRotate'+params.id+' .rtContainer').Carousel({
    position: params.p34,
    visible: params.p35,
    rotateBy: params.p36,
    speed: params.p37,
    direction: params.p42 == 'true',
    btnNext: '#partRotate'+params.id+' #nextRotate',
    btnPrev: '#partRotate'+params.id+' #prevRotate',      
    auto: params.p38 == 'true',      
    delay: params.p39,
    dirAutoSlide: params.p40 == 'true',
    margin: 0      
}); 
}
}
