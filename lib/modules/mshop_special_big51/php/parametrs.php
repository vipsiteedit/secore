<?php
 ...
 if (!isset($section->parametrs->param48)) $section->parametrs->param48 = "200x200";
 ...
 if (!isset($section->parametrs->param20)) $section->parametrs->param20 = "asc";
 ...
 if (!isset($section->parametrs->param50)) $section->parametrs->param50 = "optovik";
 if (!isset($section->parametrs->param51)) $section->parametrs->param51 = "optcorp";
 ...
 if (!isset($section->parametrs->param21)) $section->parametrs->param21 = "Y";
 if (!isset($section->parametrs->param25)) $section->parametrs->param25 = "N";
 if (!isset($section->parametrs->param27)) $section->parametrs->param27 = "N";
 if (!isset($section->parametrs->param26)) $section->parametrs->param26 = "Y";
 if (!isset($section->parametrs->param49)) $section->parametrs->param49 = "N";
