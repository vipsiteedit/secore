var mshop_flycart53_execute = function(params){ 
var cart = {},
    send_ajax = false,
    ajax_request = true,
    cart_animate = false,
...
function addAjaxCart(data){
    var new_add = '<div class="goodInfo updAjax" data-id="' + data.id + '"> ' +
        ...
        ' <a class="linkDelGood" href="javascript:void(0);" title="' + params.p11 + '">&nbsp;</a> ' +
        ' </div>';
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                var clone = object.clone(),
                    x = object.offset(), 
                    x2 = cart.last().offset();
                if (result.incart && (params.p22 == 'f' || params.p22 == 'fm')){
                ...
                if (product.closest('.notAjaxCart').length)
                    document.location.href='/'+params.p4+'/';
                if (result.product && (params.p22 == 'm' || params.p22 == 'fm')){
