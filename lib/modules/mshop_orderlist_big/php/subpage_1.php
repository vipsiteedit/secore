...
$torder->select('sp.id, sp.article, sp.name, st.nameitem, st.price, st.discount, st.count, st.license, st.commentary, so.date_order');
...
$amount = se_formatMoney($amount, $showcurr, '&nbsp;', $round_price);
