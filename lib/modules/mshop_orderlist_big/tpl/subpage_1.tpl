        ...
        <tbody class="tableBody">
            <?php foreach($section->tovarorder as $tovar): ?>
                <tr class="tableRow">
                    ...
                    <td class="tovarordertd_cn"><span><?php echo $tovar->count ?></span></td>
                    <td class="tovarordertd_sum"><span class="orderPrice"><?php echo $tovar->sum ?></span></td>
                </tr>
            
<?php endforeach; ?>
            <tr class="tableRowTotal">
                <td colspan="4" class="totalTitle"><span><?php echo $section->language->lang039 ?></span></td>
                <td class="totalCount"><span><?php echo $count ?></span></td>
