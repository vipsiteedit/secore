<div class="content forum">
    ...
    <?php else: ?>
        ...
        <?php else: ?>
            ...
            <form type='post'>
                <input type='hidden' name='id' value='<?php echo $ext_id ?>'>
                <?php echo $section->language->lang172 ?>
                <input class='buttonSend' type='submit' name='delmsg' value='<?php echo $section->language->lang173 ?>'>
                <input class='buttonSend' type='submit' name='cancel' value='<?php echo $section->language->lang142 ?>'>
            </form>
            <!--Конец тела страницы-->
...
<?php endforeach; ?>
                ...
                <?php if($allrobots!=0): ?>
                    <b id='main_Robots'>
                        <?php echo $section->language->lang147 ?>:&nbsp;<?php echo $allrobots ?>&nbsp;(
