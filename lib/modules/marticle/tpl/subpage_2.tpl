<?php if($section->parametrs->param45!='Yes'): ?>
        ...
        <div class="passert">
            ...
            <?php foreach($section->comments as $comm): ?>
                <div class="comment">
                    ...
                    <?php if($comm->access==true): ?>
                        <div class="comm_del">
                            <form style="margin:0px;" action="<?php echo seMultiDir()."/".$_page."/".$razdel."/sub3/" ?>" method="post">
...
<?php endforeach; ?> 
            <?php if($section->parametrs->param42=='Yes'): ?>
    ...
    <div class="addComment">
        <form style="margin:0px;" action="" method="POST">
            ...
            <div class="obj name">
                ...
                <div>
                    <input id="name" title="<?php echo $section->language->lang010 ?>" value="<?php echo $name ?>" name="name">
                </div>
            </div>
            <div class="obj email">                     
                <label for="email"><?php echo $section->language->lang022 ?></label>
                <div>
                    <input id="email" title="<?php echo $section->language->lang011 ?>" name="email" value="<?php echo $email ?>">
                </div>
            </div>
            <div class="obj note">
                <label for="note"><?php echo $section->language->lang023 ?></label>
                <div>
                    <textarea id="note" title="<?php echo $section->language->lang023 ?>" name="note" rows="7" cols="60"><?php echo $note ?></textarea>
                </div>
            </div>
            <?php if($section->parametrs->param15=="Yes"): ?>
                <div class="antiSpam">
                    <div  class="tablrow">
                        <img id="pin_img" src="<?php echo $capcha ?>">
                        <label><?php echo $section->language->lang026 ?></label>
                        <input class="inp inppin <?php echo $errstpin ?>" <?php echo $glob_err_stryle ?> name="pin" maxlength="5" title="<?php echo $section->language->lang026 ?>" value="" autocomplete="off">
                    </div>  
                </div>
            <?php endif; ?>
