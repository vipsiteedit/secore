...
var insert = '<tr class="tableRow itemCart updateAjax" data-id="' + data.id +'">' +
    ...
    '<td class="itemDeleteCart"><a href="' + page_link + 'delcartname/' + data.id + '/" class="btnDeleteItem" title="Удалить товар из корзины">&nbsp;</a></td></tr>';
...
$(document).ready(function () {
    ...
    $('#blockCartDelivery').on('click', '#linkSelectRegion', function(e){
        ...
        $('.blockSelectUserRegion')
            .css({
                'position': 'absolute', 
                'left': pos.left + link_region.outerWidth(true),
