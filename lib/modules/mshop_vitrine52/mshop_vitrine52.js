var mshop_vitrine52_execute = function(params){ 
...
var updReviews = function(action, data){
    ...
    if (data.count - data.offset > 0){
        $('.moreReviews').show();
        $('.countNext').html((Math.min(parseInt(vitrine.param321), data.count - data.offset)));
...
var allLOad = function(){
    ...
    imageCarousel();
    changeModifications();
    showDescription(vitrine.param307, vitrine.param308, vitrine.param309);
};allLOad();
