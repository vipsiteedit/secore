            ...
            <form method="post" action="#comments">
                ...
                <?php if($user_group==0): ?>
                    ...
                    <div class="addCaptcha form-group">
                        <label for="comment-captcha"><?php echo $section->language->lang106 ?></label>
                        <img src="/lib/cardimage.php?session=<?php echo $sid ?>&<?php echo $time ?>" alt="">
                        <input id="comment-captcha" class="form-control" type="text" name="comm_captcha" value="" required>
                    </div>
                <?php endif; ?>                
