...
<script type="text/javascript" src="[module_url]mshop_catalog_picture.js"></script>
<script type="text/javascript"> mshop_catalog_picture_execute({
...
<div class="content shopGrouppic part<?php echo $section->id ?>" data-type="<?php echo $section->type ?>" data-id="<?php echo $section->id ?>" <?php echo $section->style ?>>
