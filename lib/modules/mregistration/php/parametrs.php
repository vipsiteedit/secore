<?php
 ...
 if (!isset($section->parametrs->param50) || $section->parametrs->param50=='') $section->parametrs->param50 = "Нажимая кнопку «Отправить», я принимаю условия <a class=\"lnkLicense\" href=\"/license/\" target=\"_blank\">Пользовательского соглашения</a> и даю своё согласие на обработку моих персональных данных";
 if (!isset($section->parametrs->param51) || $section->parametrs->param51=='') $section->parametrs->param51 = "N";
 if (!isset($section->parametrs->param52) || $section->parametrs->param52=='') $section->parametrs->param52 = "Принимаю <a href=\"#\" target=\"_blank\">условия</a>";
