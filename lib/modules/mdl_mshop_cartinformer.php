<?php
function module_mshop_cartinformer($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mshop_cartinformer';
 else $__MDL_URL = 'modules/mshop_cartinformer';
 $__MDL_ROOT = dirname(__FILE__).'/mshop_cartinformer';
 ...
 $show_order_sum = $total['show_total'];
 $show_items_count = $total['count'];
