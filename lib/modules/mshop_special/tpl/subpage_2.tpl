...
<div class="morephotos">
    <h3 class="goodsMorephotoHat">Галерея</h3>
    <div id="photo">
        <?php foreach($section->photos as $foto): ?>
            <a rel="lightbox-foto" href="<?php echo $foto->image ?>"><img src="<?php echo $foto->image_prev ?>" class="imgAll" title="<?php echo $foto->title ?>" alt="<?php echo $foto->title ?>" border="0"></a>
