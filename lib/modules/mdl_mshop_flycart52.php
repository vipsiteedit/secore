<?php
function module_mshop_flycart52($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mshop_flycart52';
 else $__MDL_URL = 'modules/mshop_flycart52';
 $__MDL_ROOT = dirname(__FILE__).'/mshop_flycart52';
