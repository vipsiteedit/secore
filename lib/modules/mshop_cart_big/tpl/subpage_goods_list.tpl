        ...
        <?php foreach($section->objects as $record): ?>
            <tr class="tableRow itemCart" data-id="<?php echo $record->key ?>">
                <td class="itemImageCart">
                    <a href="<?php echo seMultiDir()."/".$section->parametrs->param1."/" ?><?php echo $record->link ?>"><img src="<?php echo $record->img ?>" alt=""></a>
                </td>                                         
                ...
                <td class="itemCountCart">
                    <div class="cartitem_count">
                        ...
                        <input class="cartitem_inputcn" type="text" name="countitem[<?php echo $record->key ?>]" value="<?php echo $record->count ?>" size="3">
...
<?php endforeach; ?>
        ...
        <tr id="trTotalOrder">
            ...
            <td colspan="2" id="tdTotalGoods">
                ...
                <div id="weightGoods">
                    Вес: <span class="cartPriceSum"><?php echo $total_weight_goods ?></span>
                </div>
                <div id="volumeGoods">
                    Объем: <span class="cartPriceSum"><?php echo $total_volume_goods ?></span>
                </div>
            </td>
        </tr>         
    </tbody> 
