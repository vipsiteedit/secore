<?php
function module_text_rating($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/text_rating';
 else $__MDL_URL = 'modules/text_rating';
 $__MDL_ROOT = dirname(__FILE__).'/text_rating';
