<?php
function module_ashop_search53($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/ashop_search53';
 else $__MDL_URL = 'modules/ashop_search53';
 $__MDL_ROOT = dirname(__FILE__).'/ashop_search53';
