<?php
function module_mvoting_txt($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mvoting_txt';
 else $__MDL_URL = 'modules/mvoting_txt';
 $__MDL_ROOT = dirname(__FILE__).'/mvoting_txt';
