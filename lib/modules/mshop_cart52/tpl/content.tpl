...
<script type="text/javascript" src="[module_url]mshop_cart52.js"></script>
<script type="text/javascript"> mshop_cart52_execute({'id':<?php echo $section->id ?>, 'link':'<?php echo seMultiDir()."/".$_page."/" ?>','p16':'<?php echo $section->parametrs->param16 ?>'});</script>
</footer:js>
