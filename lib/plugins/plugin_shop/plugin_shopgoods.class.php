    ...
    **/
    public function getSortByField($default = 'na'){
        ...
        switch ($sortval) {
            ...
            case 'aa': 
            case 'ad': $field = 'sp.article'; break;
            case 'na': 
            case 'nd': $field = 'sp.name'; break;
            case 'ma': 
            case 'md': $field = 'sp.manufacturer'; break;
            case 'pa': 
            case 'pd': $field = 'price'; break;
            case 'ca': 
            case 'cd': $field = 'presence_count_adopt'; break;
            case 'ra': 
            case 'rd': $field = 'sp.id'; break;
            case 'la': 
            case 'ld': $field = 'sp.vizits'; break;
			case 'sa': 
            case 'sd': $field = 'sp.sort'; break; 
            case 'ba': 
            case 'bd': $field = 'brand'; break; 
			default: $field = 'sp.name';$sortval = 'na';
        } 
